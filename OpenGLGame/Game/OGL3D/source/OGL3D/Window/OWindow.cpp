...
OWindow::OWindow()
{
	...
	m_handle = CreateWindowEx(NULL, MAKEINTATOM(classId), L"PardCode | OpenGL 3D Game", WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, rc.right, rc.bottom,NULL,NULL,NULL,NULL);
